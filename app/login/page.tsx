      ...
      <div className="w-full max-w-md rounded-2xl bg-surface p-8 shadow-card-hover ring-1 ring-border/60">
        ...
        <div className="mt-6 relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-surface text-muted">또는 다음으로 로그인</span>
          </div>
        </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          >
            <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
              ...
              <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.71 0-4.99-1.81-5.82-4.24H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
